<template>
    <div>
      ...
      <el-card>
        ...
        <el-table :data="userList"  border stripe>
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <!-- 删除 -->
              <el-button size="mini" type="warning" icon="el-icon-delete" @click="removeUserById(scope.row.id)"></el-button>
              <!-- 分配角色 -->
        ...
        <!-- 分配角色对话框 -->
        <el-dialog title="分配角色" :visible.sync="setRoleDialogVisible" width="50%" @close="setRolesDialogClosed">
          <div>
